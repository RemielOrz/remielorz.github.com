...
$(function() {
    ...
    $(window);
    var d = new createjs.Stage(b), e = new createjs.Shape((new createjs.Graphics).beginFill("#000").drawRect(0, 0, b.width + 1, b.height));
    e.alpha = .25, d.addChild(e), d.autoClear = !1;
    var f = new createjs.Container, g = new createjs.Text("These words I have waited for", "36px Josefin Slab", "#fff");
    ...
    var l = new createjs.Container, m = new createjs.Text("Thanks for being with me", "35px Josefin Slab", "#fff");
    ...
    var cb = new createjs.Container, db = new createjs.Text("For the most beautiful you in Dec 24th, 2012.", "35px Josefin Slab", "#fff");
